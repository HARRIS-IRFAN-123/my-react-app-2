...
const CourseOne = () => {
  ...
  const footerImages = {
    ...
    return (
        <>
        <header>
        <h4>Data Science In 2023</h4>
        </header>
        <div className='container-fluid p-4 text-center'>
            <h1>
            Data Science
        <img src={science} className='science' alt='science'/>
            </h1>
            <h5>Data science is a field that uses scientific methods, processes, algorithms, and systems to extract knowledge and insights from data. Data scientists use their skills to collect, clean, analyze, and interpret data to solve real-world problems.</h5>
