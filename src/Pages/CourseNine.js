...
const CourseNine = () => {
  ...
  const handleNavLinkClick = (sectionId) => {
    setActiveSection(sectionId); // Update the active section when a button is clicked
  };
  ...
  return (
    <>
      <header>
        <h4>Mobile Development In 2023</h4>
      </header>
      <div className='container-fluid p-4 text-center'>
        ...
        <h5>Mobile development is the process of creating mobile apps. It includes the creation of the user interface, the functionality, and the back-end code that powers the app. Mobile apps can be developed for a variety of platforms, including Android, iOS, and Windows Phone.</h5>
        ...
        <nav>
          <ul className='nav-list'>
            ...
            <li>
              <button
                onClick={() => handleNavLinkClick('learn')}
            ...
            <li>
              <button
                onClick={() => handleNavLinkClick('instructors')}
                className={activeSection === 'instructors' ? 'active' : ''}
              >
                Instructors
              </button>
            </li>
            <li>
              <button
                onClick={() => handleNavLinkClick('enroll')}
                className={activeSection === 'enroll' ? 'active' : ''}
              >
                Ways to Enroll
              </button>
            </li>
    ...
    <div className='Description'>
      ...
      <div className='footer-container'>
        <div className='footer-content'>
          ...
          <h4>{courseTopic}</h4>
          <p>
          Break Into  Mobile Development
          <p>Learn How to Build Mobile Apps</p>
          <p>Learn React Native from Beginners to Advance</p>
