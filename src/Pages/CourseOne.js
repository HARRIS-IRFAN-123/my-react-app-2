  ...
  return (
    <>
      ...
      <div className='container-fluid p-4 text-center'>
        ...
        <h5>Data analysis is the process of inspecting, cleaning, transforming, and modeling data with the goal of discovering useful information, informing conclusions, and supporting decision-making.</h5>
      ...
      <h3>How does the training work</h3>
