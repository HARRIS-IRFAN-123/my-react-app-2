...
const CourseTwo = () => {
  ...
  return (
      ...
      <header>
      <h4>Full Stack Development In 2023</h4>
      </header>
       <div className='container-fluid p-4 text-center'>
         <h1>Full Stack Development</h1>
         <img src={development} className='development-image' alt='development'/>
         <h5>Full stack development is a software development approach in which a developer works on both the front-end and back-end of a web application. This means that a full stack developer is responsible for both the user interface (UI) and the underlying logic of the application.</h5>
