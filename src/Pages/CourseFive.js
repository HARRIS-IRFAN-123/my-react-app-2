...
import "./CourseFive.css"
const CourseOne = () => {
  const [activeSection, setActiveSection] = useState(null);
  const [courseTopic, setCourseTopic] = useState('Machine');
    ...
    return (
        <>
        <header>
        <h4>Machine Learning In 2023</h4>
        </header>
        <div className='container-fluid p-4 text-center'>
            <h1>
            Machine Learning
        <img src={machine} className='machine' alt='machine'/>
            </h1>
            <h5>Machine learning and deep learning are two of the most powerful tools in the field of artificial intelligence. Machine learning algorithms can learn from data and make predictions, while deep learning algorithms can learn to recognize patterns and make decisions in a way that is similar to how humans do.</h5>
