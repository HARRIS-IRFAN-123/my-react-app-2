...
const CourseOne = () => {
    ...
    return (
       <>
       <header>
        <h4>Blockchain In 2023</h4>
       </header>
        <div className='container-fluid p-4 text-center'>
            <h1>
                Blockchain
        <img src={Blockchain} className='blockchain' alt='blockchain'/>
            </h1>
            <h5>Blockchain is a distributed ledger technology that allows for secure, transparent, and tamper-proof transactions. It is a system of recording information in a way that makes it difficult or impossible to change, hack, or cheat the system.</h5>
